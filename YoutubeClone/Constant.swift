...
typealias video = (url: URL, type: VideoType, playedTime: CMTime)
...
var videos = [
    (firstURL, VideoType.normal, CMTime(seconds: 0, preferredTimescale: .max)),
    (secondURL, VideoType.normal, CMTime(seconds: 0, preferredTimescale: .max)),
    (thirdURL, VideoType.ad, CMTime(seconds: 0, preferredTimescale: .max)),
    (fourthURL, VideoType.normal, CMTime(seconds: 0, preferredTimescale: .max))
]
